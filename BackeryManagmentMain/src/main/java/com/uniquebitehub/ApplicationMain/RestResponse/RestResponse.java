package com.uniquebitehub.ApplicationMain.RestResponse;
...
import com.uniquebitehub.ApplicationMain.Utill.DateHelper;
...
public class RestResponse implements Map<String, Object> {
	...
	public static RestResponse build() {
		return new RestResponse().withCurrentTimestamp(DateHelper.getCurrentTimestampFormatted());
	}
	...
	public RestResponse withCurrentTimestamp(String string) {
		return add(KEY_CURRENT_TIMESTAMP, string);
	}
	...
	public RestResponse withError(String errorMessage, Object statusCode, Object statusMessage, String[] parameters) {
		return add(KEY_STATUS, STATUS_ERROR).add(KEY_MESSAGE, errorMessage).add(KEY_STATUS_CODE, statusCode)
				.add(KEY_STATUS_MESSAGE, statusMessage).add(KEY_PARAMETERS, parameters);
	}
	...
	public RestResponse withSuccess(String message, Object data, Object statusCode, Object statusMessage) {
		return withSuccess(message, KEY_DATA, data).add(KEY_STATUS_CODE, statusCode).add(KEY_STATUS_MESSAGE,
				statusMessage);
	}
